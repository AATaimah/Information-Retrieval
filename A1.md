...
```bash
zip -r Assignment1_submission.zip A1.md src outputs Results Results_title_only Results_title_plus_text trec_eval -x "*/.DS_Store" "*/__pycache__/*" "*.pyc" "trec_eval/trec_eval.dSYM/*"
```
